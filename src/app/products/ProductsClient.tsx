...
function ProductFamilyGrid() {
  ...
  return (
    <section id="product-grid" className="bg-be-white section-padding-major">
      <div className="container-site page-horizontal-padding">
...
function ComparisonTable() {
  return (
    <section className="bg-be-cream section-padding-supporting">
      <div className="container-site page-horizontal-padding">
        <div className="reveal-up mb-8">
          <SectionHeader
            eyebrow="COMPARISON"
...
function SelectionGuidance() {
  return (
    <section className="bg-be-white section-padding-supporting">
      <div className="container-site page-horizontal-padding">
        <div className="reveal-up mb-8">
          <SectionHeader
...
function TechnicalHelpCTA() {
  return (
    <section className="bg-be-yellow-50 section-padding-supporting">
      <div className="container-site page-horizontal-padding">
