/* ────────────────────────────────────────────────────────────────
   Bi-Color Insulating Mats — Product Detail Page
   Route: /products/bi-color-insulating-mats
   SEO title: "Bi-Color Insulating Mats | Bharat Electrosafe"
   ──────────────────────────────────────────────────────────────── */
...
const SEO_TITLE = 'Bi-Color Insulating Mats | Bharat Electrosafe';
const SEO_DESCRIPTION =
  'IS 15652 bi-color insulating mats with dual-layer surface for wear indication. The contrasting upper layer makes excessive wear, cuts or surface damage more visible, supporting inspection and replacement decisions.';
const CANONICAL_PATH = '/products/bi-color-insulating-mats';
