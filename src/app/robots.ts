 ...
 * Defaults to "off" to avoid indexing the site in preview / staging environments.
 * When enabled, the entire site is allowed for crawling and the sitemap URL is exposed.
 */
