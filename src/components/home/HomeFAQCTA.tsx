 ...
 *
 * The small inline "Technical Guidance" text link inside the FAQ intro
 * is the only conversion affordance in this section — no separate button
 * CTA row sits below the questions.
 */
