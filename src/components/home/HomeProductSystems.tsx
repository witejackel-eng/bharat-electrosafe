      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="mt-12 md:mt-16 flex flex-col gap-8 md:gap-16">
          {productSystems.map((system, i) => (
            <Reveal key={system.id} delay={i * 120} translateY={24}>
              <div
              ...
              >
                ...
                <div className={`md:col-span-7 relative ${i % 2 === 1 ? 'md:[direction:ltr]' : ''}`}>
                ...
                <div className={`md:col-span-5 flex flex-col gap-3 ${i % 2 === 1 ? 'md:[direction:ltr]' : ''}`}>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 text-sm font-medium text-orange hover:text-orange-hover mt-3 transition-colors group/link"
                  >
