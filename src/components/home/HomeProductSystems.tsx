              ...
              <Reveal delay={i * 120} translateY={24}>
                ...
                >
                  ...
                  <button
                    ...
                    className={`md:col-span-7 relative w-full ${i % 2 === 1 ? 'md:[direction:ltr]' : ''} text-left`}
                    aria-label={`View ${system.name} details`}
                  >
                    <div className="relative w-full aspect-[16/10] rounded-2xl overflow-hidden bg-muted cursor-pointer">
