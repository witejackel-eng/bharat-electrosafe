        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="reveal-up lg:w-7/12">
            ...
            {submitStatus === 'success' && (
              <div className="mb-6 p-4 rounded-lg bg-be-yellow-50 border border-be-yellow-400 text-be-charcoal-950">
                <p className="font-semibold">Enquiry sent successfully!</p>
                <p className="text-body text-be-grey-650 mt-1">
                  Our team will reach out to you shortly. Thank you for contacting Bharat Electrosafe.
                </p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    type="text"
                    {...register('company')}
                    className="h-11 rounded-lg border border-be-grey-250 bg-be-white px-4 text-base outline-none transition-colors focus:border-be-yellow-500 focus:ring-2 focus:ring-be-yellow-500/20"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  >
                    <SelectTrigger className="h-11 rounded-lg border border-be-grey-250 bg-be-white text-base focus:border-be-yellow-500">
